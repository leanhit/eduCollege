...
public class UserResponse {
    ...
    public static UserResponse fromDemo(com.chatbot.core.academic.model.Student student) {
        return UserResponse.builder()
            .id(student.getId())
    ...
    public static UserResponse fromDemo(com.chatbot.core.academic.model.Teacher teacher) {
        return UserResponse.builder()
            .id(teacher.getId())
